    ...
    this.creditCardIframe = function () {
      ...
      var Execute = function (callback) {
        ...
        if (!iframe_element) {
          ...
          loadScript("https://wws.ips-payment.com/6598874bb8d7bfdb56df4b5d6f4b56d/js/iframeResizer.min.js", function () {
            iFrameResize({
      ...
      var _generateIframeUrl = function (paramsPayment) {
        ...
        if (paramsPayment.Token) {
          ...
          props.iframe_endpoint = "https://wws.ips-payment.com/init_transactions/?SACS=";
          ...
          props.iframe_endpoint = "https://wws.ips-payment.com/?";
