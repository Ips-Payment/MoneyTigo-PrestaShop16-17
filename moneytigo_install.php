...
class MoneytigoInstall
{
    ...
    */
    ...
    public function updateConfiguration()
    {
        ...
        Configuration::updateValue('MONEYTIGO_URI_API_PAYMENT', 'https://wws.ips-payment.com/');
        Configuration::updateValue('MONEYTIGO_URI_API_GET_TRANSACTION', 'https://wws.ips-payment.com/transactions/');
        Configuration::updateValue('MONEYTIGO_URI_API_INIT_TRANSACTION', 'https://wws.ips-payment.com/init_transactions/');
		Configuration::updateValue('MONEYTIGO_URI_LIBRARY', 'https://wws.ips-payment.com/6598874bb8d7bfdb56df4b5d6f4b56d/js/IPSSDK-Cms.js');
    }
